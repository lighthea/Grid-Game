...
public class Lochowsko extends EnigmeNPC {
    /**
    ...
    public Lochowsko(Area area, Orientation orientation, DiscreteCoordinates position, float damages, boolean fixed, int coolDown, String[] dialogText, boolean active, DiscreteCoordinates... path) {
        super(area, orientation, position, damages, fixed, coolDown, dialogText, active, path);
        initialRise = .55f;
        initialWidth = .55f;
        this.sprite = new Sprite("girl.4", 1, 1.f,this) ;
