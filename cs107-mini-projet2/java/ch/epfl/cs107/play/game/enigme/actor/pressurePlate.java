...
public class pressurePlate extends AreaEntity implements Interactable, Signal {
    ...
    public void draw(Canvas canvas) {
        if (is(this, 1)) sprite = new Sprite("GroundPlateOn", 1, 1,this);
        else sprite = new Sprite("GroundPlateOff", 1, 1,this);
        sprite.draw(canvas);
    }
